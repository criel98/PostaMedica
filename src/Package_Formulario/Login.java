...
public class Login extends javax.swing.JFrame {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        // 1. Capturamos los datos que el empleado ingresó en las cajas de texto
        String inputUser = txtUser.getText();
        String inputPass = String.valueOf(txtPass.getPassword());
        ...
        if (usuarioRegistrado.validarLogin(inputUser, inputPass)) {
            ...
            // 4. Si el login falla, le consultamos al objeto cuál es la situación actual
            if (usuarioRegistrado.isBloqueado()) {
                // Mensaje de bloqueo definitivo si ya alcanzó el límite
                JOptionPane.showMessageDialog(this, "Has superado el límite de 3 intentos. Esta cuenta ha sido bloqueada.", "Acceso Bloqueado", JOptionPane.ERROR_MESSAGE);

                // Bloqueamos físicamente los componentes visuales de tu JFrame
                ...
                JOptionPane.showMessageDialog(this, "Datos incorrectos. Intentos restantes: " + intentosRestantes, "Error de Autenticación", JOptionPane.WARNING_MESSAGE);
            }
        }
